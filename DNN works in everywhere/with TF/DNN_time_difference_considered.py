...
def DNN(target, saveOrNot, loadOrNot, inputFile, activation_function,label,data,time_stamp):
...
if __name__ == "__main__":
    ...
    for i in [0,4,8,12]:
        ...
        DNN(target, saveOrNot, loadOrNot, inputFile, activation_function, label, data,i)
